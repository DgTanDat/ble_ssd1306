...
#define SAMPLE_DEVICE_NAME          "NHOM2.2"
...
static const uint16_t CHAR_1_SHORT_WR              = 0xFF03;
...
static const uint8_t char1_name[]  = "ID input";
...
static const esp_gatts_attr_db_t gatt_db[HRS_IDX_NB] =
{
    ...
    [IDX_CHAR_VAL_A] =
    {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&CHAR_1_SHORT_WR, ESP_GATT_PERM_WRITE,
    ...
    switch (event) {
        ...
        case ESP_GAP_BLE_AUTH_CMPL_EVT: {
            ...
            if (param->ble_security.auth_cmpl.success){
                ...
                printf("Please input ID for each member team: \n");
            }
            else {
